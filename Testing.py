...
class Series(TestCase):
    ...
    def test_temporadas_community(self):
        self.assertEqual(6, Serie.get_cant_temporadas("https://www.netflix.com/title/70155589"))

    def test_temporadas_house_of_cards(self):
        self.assertEqual(6, Serie.get_cant_temporadas("https://www.netflix.com/title/70178217"))

    def test_temporadas_oitnb(self):  # orange is the new black
        self.assertEqual(7, Serie.get_cant_temporadas("https://www.netflix.com/title/70242311"))
